...
async function getGeminiSummary(text, summaryType, apiKey) {
  ...
  switch (summaryType) {
    case "brief":
      prompt = `Provide a brief summary of the following article in 10 sentences:\n\n${truncatedText}`;
      break;
    case "detailed":
      prompt = `Provide a more extended detailed summary of the following article, covering all main points and key details:\n\n${truncatedText}`;
      break;
    case "bullets":
      prompt = `Summarize the following article in 10 key points. Format each point as a line starting with \"- \" (dash followed by a space):\n\n${truncatedText}`;
      break;
    default:
